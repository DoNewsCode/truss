...
import (
	...
	helper "github.com/DoNewsCode/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/DoNewsCode/truss/gengokit/general-service",
	...
	expected := `
        ...
        import (
        	...
        	pb "github.com/DoNewsCode/truss/gengokit/general-service"
        )
