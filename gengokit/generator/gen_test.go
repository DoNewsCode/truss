...
import (
	...
	"github.com/DoNewsCode/truss/gengokit"
	templateFileAssets "github.com/DoNewsCode/truss/gengokit/template"
	"github.com/DoNewsCode/truss/svcdef"

	"github.com/DoNewsCode/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/DoNewsCode/truss/deftree/google/annotations.proto";
		option go_package = ".;general";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/DoNewsCode/truss",
...
func TestAllTemplates(t *testing.T) {
	t.Skip()
	const goPackage = "github.com/DoNewsCode/truss/gengokit"
	const goPBPackage = "github.com/DoNewsCode/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/DoNewsCode/truss/gengokit",
		PBPackage: "github.com/DoNewsCode/truss/gengokit/general-service",
	}
